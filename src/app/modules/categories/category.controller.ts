...
const categorySingleGetData = catchAsync(async(req:Request, res:Response)=>{
...
const categoryUpdateGetData = catchAsync(async(req:Request, res:Response)=>{
    const categoryId = req.params.id
    const result = await categoryService.categoryUpdateGetData(req.body,categoryId)
   sendResponse(res,{
    statusCode: 200,
    success: true,
...
const categoryDeletedGetData = catchAsync(async(req:Request, res:Response)=>{
    const categoryId = req.params.id
